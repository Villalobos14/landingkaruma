    ...
    <section className="relative isolate overflow-hidden bg-primary py-24 sm:py-32">
      ...
      >
        <div
          ...
          className="aspect-1097/845 w-[68.5625rem] bg-linear-to-tr from-[#ffffff] to-[#000] opacity-20"
        />
      </div>
      <div
        aria-hidden="true"
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.name} className="flex flex-col-reverse gap-1">
                ...
                <dd className="text-4xl font-semibold tracking-tight text-complementary">{stat.value}</dd>
              </div>
            ))}
          </dl>
        </div>
